...
module PopUpManager {
	...
	* duration          动画持续时间
    */
	export function addPopUp(panel, dark: boolean = false, popUpWidth: number = 0, popUpHeight: number = 0, effectType: number = 0, isAlert: boolean = false, duration: number = 500): void {
